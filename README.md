...
A deterministic compiler that transforms source code into **Crystals** - cryptographically certified knowledge artifacts. Built in Rust, implementing the [Glyph Foundry Framework](glyph_foundry_spec.pdf).
